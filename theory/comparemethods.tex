...
\end{tabulary}
\caption{Comparison of quantum system analysis approaches. In the ranking 5 = good and 1 = poor. The \textsc{Boltzmann} Transport Equation (BTE), \textsc{Schr\"odinger} Equation (SE), Transfer Matrix (TM), Density Matrix (DM), \textsc{Green}'s Function (GF) and \tesxtsc{Wigner} Function (WF) are compared. Slightly modified from \textsc{Biegel}, see \cite{Biegel97quantumelectronic}} 
