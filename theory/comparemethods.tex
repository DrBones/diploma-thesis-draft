The \gfnc{} formulation of quantummechanics is not the only possible method to compute the transport properties desired.\par
...
\end{tabulary}
\caption{Comparison of quantum system analysis approaches, see \cite{Biegel97quantumelectronic}. In the ranking 5 = good and 1 = poor. Comparison includes \textsc{Boltzmann} Transport Equation (BTE), \textsc{Schr\"odinger} Equation (SE), Transfer Matrix (TM), Density Matrix (DM), \textsc{Green}'s Function (GF) and \tesxtsc{Wigner} Function (WF).} 
