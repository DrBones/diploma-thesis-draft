...
\begin{figure}[h!]
\subfloat[]{\label{fig:ring15edens}\includegraphics[]{images/ring3edens}}
\subfloat[]{\label{fig:ring25edens}\includegraphics[]{images/ring5edens}}
...
\end{figure}
\begin{figure}[h!]
\subfloat[]{\label{fig:ring15spindens}\includegraphics[]{images/ring3spindens}}
\subfloat[]{\label{fig:ring25spindens}\includegraphics[]{images/ring5spindens}}
