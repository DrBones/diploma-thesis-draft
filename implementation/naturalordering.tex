...
\end{tikzpicture}}
\caption{(a) Schematic of a discretized nanowire with as a layered structure. The leads are connected to the left and right side. The dots denote lattice points. The slices are indicated by alternating white and gray background. (b) Hamiltonian of the discretized nanowire. The Blocks are highlighted by dashed lines.}
\label{fig:layered}
\end{figure}
