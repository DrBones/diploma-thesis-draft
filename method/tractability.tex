...
\subsubsection{Lead Surface \cgfnc s}
...
\subsubsection{Recursive \cgfnc{} Algorithm}
\label{sec:rgapresentation}
\todo[noline]{finish, more formulas and maybe nice infographic}
...
\begin{figure}
\missingfigure{RGA infographic ..Pretty and simple!!!}
