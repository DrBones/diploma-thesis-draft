...
\centering
\includegraphics[scale=0.7]{images/selfenergy}
\caption{Separation of conductor and lead. The dots denote lattice points. The white area represents the semi-infinite lead, the gray area denotes the conductor.}
