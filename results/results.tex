A 2DEG in a heterojunction is investigated. This chapter is partitioned into two parts. The first part examines the transport properties of a nanowire for differnet quantum point contacts.\par
...
\begin{figure}[h!]
\subfloat[]{\label{fig:curvedens1}\includegraphics[]{images/curve_1modes_edens}}
\subfloat[]{\label{fig:curvedens2}\includegraphics[]{images/curve_2modes_edens}}
\subfloat[ ]{\label{fig:curvedens3}\includegraphics[]{images/curve_3modes_edens}}
...
\end{figure}
\begin{figure}[h!]
\subfloat[]{\label{fig:curvspindens1}\includegraphics[]{images/curve_1modes_spindens}}
\subfloat[]{\label{fig:curvspindens2}\includegraphics[]{images/curve_2modes_spindens}}
\subfloat[]{\label{fig:curvspindens3}\includegraphics[]{images/curve_3modes_spindens}}
