...
\draw[dashed,lightgray] (-0.85,6) .. controls (-0.9,1.75) and (0.7,1.7) .. (1.23,1.35);
\draw[dashed,lightgray] (0.18,6) .. controls(0.25,3.3) and (0.58,2.8) .. (1.23,2.35);}
\newcommand{\curveoutlinedark}{
\draw[dashed,gray] (-0.8,6) .. controls (-0.9,1.75) and (0.7,1.7) .. (1.23,1.35);
\draw[dashed,gray] (0.18,6) .. controls(0.25,3.3) and (0.58,2.8) .. (1.23,2.35);}
